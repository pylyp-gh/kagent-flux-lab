...
warn "MetalLB pool in Phase 4 taken from the high range of this subnet (default: 172.20.1.200-250)"

echo
say "Cluster ready. LoadBalancer IPs not yet available — MetalLB deploys in Phase 4."
